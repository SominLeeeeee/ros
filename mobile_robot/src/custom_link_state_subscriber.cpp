...
public:
    ...
    , base_vel(0.0)
    {
        ...
        */
        if(!private_nh.getParam("link_state_params/base_link_id", base_link_id)) throw std::runtime_error("set base_link_id");
        if(!private_nh.getParam("link_state_params/odom_link_id", odom_link_id)) throw std::runtime_error("set odom_link_id");
